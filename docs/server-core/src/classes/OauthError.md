...
[Documentation](../../../README.md) / [server-core/src](../README.md) / OauthError

# Class: OauthError

Defined in: packages/server-core/src/errors.ts:16
...
> **new OauthError**(`status`, `error`, `error_description`, `data`): `OauthError`

Defined in: packages/server-core/src/errors.ts:22
...
Defined in: packages/server-core/src/errors.ts:20
...
Defined in: packages/server-core/src/errors.ts:17
...
Defined in: packages/server-core/src/errors.ts:18
...
Defined in: packages/server-core/src/errors.ts:19
...
> **toResponse**(`data`): [`OauthErrorResponse`](../type-aliases/OauthErrorResponse.md)

Defined in: packages/server-core/src/errors.ts:36
...
[`OauthErrorResponse`](../type-aliases/OauthErrorResponse.md)
