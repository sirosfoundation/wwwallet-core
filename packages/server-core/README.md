...
```sh
npm i @wwwallet/server-core
```

## Documentation

This package is part of a repository containing multiple sources https://github.com/sirosfoundation/wwwallet-core. The full documentation is available on GitHub.
